...
?>
	 <div class="portlet box blue">
					  ...
					  <div class="portlet-body form">
							<form role="form" action="addServicioProc.php" enctype="multipart/form-data" method="post">
							<div class="form-body">
							   ...
							   <div class="form-group">
								  ...
								  <textarea class="form-control" name="descripcion" maxlength="2000" rows="10" cols="50" placeholder="Descripción del servicio" required ></textarea> 
							   </div>
							   <div class="form-group">
								  <label for="exampleInputEmail1">Horario:</label>
								  <input class="form-control" name="horario" placeholder="Horario del servicio" required>
							   </div>
							   <div class="form-group">
								  <label for="exampleInputEmail1">Precio:</label>
								  <input class="form-control" name="precio" placeholder="Precio del servicio" required>
							   </div>
							   <div class="form-group">
