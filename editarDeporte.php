...
<?php
	{ 
		...
		$idDeporte = $_POST["idDeporte"];//$row['CALC_INV'];
...
?>
	...
	<div class="portlet box blue">
		...
		<div class="portlet-body form">
			<form role="form" action="EditDeporteProc.php" method="post">
				<div class="form-body">
					<div class="form-group">
								  <label for="exampleInputEmail1">Nombre:</label>
								  <input type="hidden" name="idDeporte" value="<?php echo $idDeporte;?>">
								  <input class="form-control" name="nombre" placeholder="Nombre del deporte" value="<?php echo $nombre;?>" required>
							   </div>
