		   ...
		   function IsNumeric(input){
            ...
            $(function(){
                ...
                $(".btnModal").click(function(){
                    var idDeporte=$(this).attr("id_obj");
					var nombre=$(this).attr("nombre");
					
					$variablesPase = {'idDeporte':idDeporte, 'nombre':nombre};
					...
					if(relacionado=="seeObj"){
						...
						$("#respEditData").load("editarDeporte.php",$variablesPase);
					}else if(relacionado=="removeObj"){
						var r=window.confirm("¿Desea eliminar el objeto seleccionado?");
						if (r==true){
							$("#respDelete").load("eliminarDeporteProc.php",{'idDeporte':idDeporte});
							$(".fila").each(function(){
								if($(this).attr("id_obj")==idDeporte){
									$(this).remove();
								}
							})
							var total = 0;
				...
				$("#btnNuevo").click(function(){
					$("#respAddData").load("addDeporte.php");					         			
				});
...
<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption" >
			<i class="icon-pencil"></i> Deportes
        </div>
	...
	<div class="portlet-body">
		...
		<table align="center" class="table  table-striped table-bordered">
			<tr>
				...
				<td align="center"><b>Nombre Deporte</b></td>
			...
			?>
					...
					<div id="respSee" class="modal fade" tabindex="-1" data-width="760">
                          ...
                          <div class="modal-footer">
                              <button type="button" data-dismiss="modal" class="btn btn-default" style="background-color:#00824f; color:white">Cerrar</button>
                          </div>
                    </div>
					 ...
					 <div id="respCancel" class="modal fade" tabindex="-1" data-width="760">
                          ...
                          <div class="modal-footer">
                              <button type="button" data-dismiss="modal" class="btn blue" style="background-color:#00824f; color:white">SÍ</button>
                              <button type="button" data-dismiss="modal" class="btn blue" style="background-color:#00824f; color:white">NO</button>
                          </div>
                     </div>
