		   ...
		   function IsNumeric(input){
            ...
            $(function(){
                ...
                $(".btnModal").click(function(){
                    var idClub=$(this).attr("id_obj");
					var nombre=$(this).attr("nombre");
					
					$variablesPase = {'idClub':idClub, 'nombre':nombre};
					...
					if(relacionado=="seeObj"){
						...
						$("#respEditData").load("editarClub.php",$variablesPase);
					}else if(relacionado=="removeObj"){
						var r=window.confirm("¿Desea eliminar el objeto seleccionado?");
						if (r==true){
							$("#respDelete").load("eliminarClubProc.php",{'idClub':idClub});
							$(".fila").each(function(){
								if($(this).attr("id_obj")==idClub){
									$(this).remove();
								}
							})
							var total = 0;
	...
	<div class="portlet-body">
		...
		<table align="center" class="table  table-striped table-bordered">
			<tr>
				...
				<td align="center"><b>Nombre Club</b></td>
