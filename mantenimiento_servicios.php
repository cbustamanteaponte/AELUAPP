		   ...
		   function IsNumeric(input){
            ...
            $(function(){
                ...
                $(".btnModal").click(function(){
                    var idServicio=$(this).attr("id_obj");
					...
					$variablesPase = {'idServicio':idServicio, 'nombre':nombre, 'descripcion':descripcion,'horario':horario,'precio':precio,'imagen':imagen,'logo':logo};
					...
					if(relacionado=="seeObj"){
						...
						$("#respEditData").load("editarServicio.php",$variablesPase);
					}else if(relacionado=="removeObj"){
						var r=window.confirm("¿Desea eliminar el objeto seleccionado?");
						if (r==true){
							$("#respDelete").load("eliminarServicioProc.php",{'idServicio':idServicio});
							$(".fila").each(function(){
								if($(this).attr("id_obj")==idServicio){
									$(this).remove();
								}
							})
							var total = 0;
				...
				$("#btnNuevo").click(function(){
					$("#respAddData").load("addServicio.php");					         			
				});
...
<?php
	...
	/*
		...
		*/
		include "dbconex.php";
		$sql = "select * from Servicio WHERE Activo='ACT';";
		$conn = conectarBD();
	...
	<div class="portlet-body">
		...
		<table align="center" class="table  table-striped table-bordered">
			<tr>
				...
				<td align="center"><b>Nombre Sercicio</b></td>
			...
			<?php
				...
				while ($col = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC)) {
					...
					$horario = utf8_encode($col['Horario']);
					$precio = utf8_encode($col['Precio']);
			...
			<tr class="fila"  id_obj="<?php echo printVar($id); ?>">
				...
				<td align="center">						   
					...
					<a class="btnModal opci"  relacionado="editObj" 
						...
						horario="<?php echo printVar($horario); ?>"
						precio="<?php echo printVar($precio); ?>"
