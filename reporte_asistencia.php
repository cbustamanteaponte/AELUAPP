	...
	<div class="portlet-body">
		<table align="center" class="table  table-striped table-bordered">
			<tr>
                ...
                <td align="center"><b>#Asistentes</b></td>
            </tr>
			<?php
				$existen=0;
				$pesoTotal=0;
				...
				while ($col = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC)) {
					...
					$sql2 = "select count(ED.EventoDispositivoID) as asistentes from EventoDispositivo ED where ED.EventoID=".$id;
					//echo $sql2;
					$stmt2 = sqlsrv_query( $conn, $sql2 );
					sqlsrv_fetch( $stmt2 );
					$asistentes = sqlsrv_get_field( $stmt2, 0);
			?>
