...
<?php
	{ 
		...
		$idAcademia = $_POST["idAcademia"];//$row['CALC_INV'];
...
?>
	...
	<div class="portlet box blue">
		...
		<div class="portlet-body form">
			<form role="form" action="EditAcademiaProc.php" enctype="multipart/form-data" method="post">
				<div class="form-body">
					<div class="form-group">
								  <label for="exampleInputEmail1">Nombre:</label>
								  <input type="hidden" name="idAcademia" value="<?php echo $idAcademia;?>">
								  <input class="form-control" name="nombre" placeholder="Nombre del academia" value="<?php echo $nombre;?>" required>
					</div>
					 <div class="form-group">
