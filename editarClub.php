...
<?php
	{ 
		...
		$idClub = $_POST["idClub"];//$row['CALC_INV'];
...
?>
	...
	<div class="portlet box blue">
		...
		<div class="portlet-body form">
			<form role="form" action="EditClubProc.php" method="post">
				<div class="form-body">
					<div class="form-group">
								  <label for="exampleInputEmail1">Nombre:</label>
								  <input type="hidden" name="idClub" value="<?php echo $idClub;?>">
								  <input class="form-control" name="nombre" placeholder="Nombre del club" value="<?php echo $nombre;?>" required>
							   </div>
