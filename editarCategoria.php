...
<?php
	{ 
		...
		$idCategoria = $_POST["idCategoria"];//$row['CALC_INV'];
...
?>
	...
	<div class="portlet box blue">
		...
		<div class="portlet-body form">
			<form role="form" action="EditCategoriaProc.php" method="post">
				<div class="form-body">
					<div class="form-group">
								  <label for="exampleInputEmail1">Nombre:</label>
								  <input type="hidden" name="idCategoria" value="<?php echo $idCategoria;?>">
								  <input class="form-control" name="nombre" placeholder="Nombre de la categoría" value="<?php echo $nombre;?>" required>
							   </div>
