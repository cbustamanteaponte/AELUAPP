		   ...
		   function IsNumeric(input){
            ...
            $(function(){
                ...
                $(".btnModal").click(function(){
                    var idLugar=$(this).attr("id_obj");
					var nombre=$(this).attr("nombre");
					var latitud=$(this).attr("latitud");
					var longitud=$(this).attr("longitud");
					
					$variablesPase = {'idLugar':idLugar, 'nombre':nombre,'latitud':latitud,'longitud':longitud};
					...
					if(relacionado=="seeObj"){
						...
						$("#respEditData").load("editarLugar.php",$variablesPase);
					}else if(relacionado=="removeObj"){
						var r=window.confirm("¿Desea eliminar el objeto seleccionado?");
						if (r==true){
							$("#respDelete").load("eliminarLugarProc.php",{'idLugar':idLugar});
							$(".fila").each(function(){
								if($(this).attr("id_obj")==idLugar){
									$(this).remove();
								}
							})
							var total = 0;
				...
				$("#btnNuevo").click(function(){
					$("#respAddData").load("addLugar2.php");					         			
				});
...
<div class="portlet box blue">
	...
	<div class="portlet-body">
		...
		<div class="table-toolbar">
    		<div class="btn-group">
				<button class="btn" style="background-color:#f6921e; color: white;" onclick="window.location.href='addLugarMapa.php'">
		...
		<table align="center" class="table  table-striped table-bordered">
			<tr>
				...
				<td align="center"><b>Nombre Lugar</b></td>
				<td align="center"><b>Latitud</b></td>
				<td align="center"><b>Longitud</b></td>
			...
			<tr class="fila"  id_obj="<?php echo printVar($id); ?>">
				...
				<td align="center">						   
					...
					<a 
						...
						latitud="<?php echo printVar($latitud); ?>"
						longitud="<?php echo printVar($longitud); ?>"
						href="editarLugarMapa.php?id=<?php echo $id;?>&lat=<?php echo $latitud;?>&lon=<?php echo $longitud;?>&nombre=<?php echo $nombre;?>"><i style="color:brown" class="icon-pencil text"  content="&nbsp;&nbsp;&nbsp;Editar"></i>
					</a><a class="opci">&nbsp;&nbsp;&nbsp;</a>
