...
?>
	 <div class="portlet box blue">
					  ...
					  <div class="portlet-body form">
							<form role="form" action="addNoticiaProc.php" enctype="multipart/form-data" method="post">
							<div class="form-body">
							   <div class="form-group">
								  <label for="exampleInputEmail1">Título:</label>
								  <input class="form-control" name="titulo" placeholder="Título de la noticia" required>
							   </div>
							   <div class="form-group">
