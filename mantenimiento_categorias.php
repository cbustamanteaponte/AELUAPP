		   ...
		   function IsNumeric(input){
            ...
            $(function(){
                ...
                $(".btnModal").click(function(){
                    var idCategoria=$(this).attr("id_obj");
					var nombre=$(this).attr("nombre");
					
					$variablesPase = {'idCategoria':idCategoria, 'nombre':nombre};
					...
					if(relacionado=="seeObj"){
						...
						$("#respEditData").load("editarCategoria.php",$variablesPase);
					}else if(relacionado=="removeObj"){
						var r=window.confirm("¿Desea eliminar el objeto seleccionado?");
						if (r==true){
							$("#respDelete").load("eliminarCategoriaProc.php",{'idCategoria':idCategoria});
							$(".fila").each(function(){
								if($(this).attr("id_obj")==idCategoria){
									$(this).remove();
								}
							})
							var total = 0;
				...
				$("#btnNuevo").click(function(){
					$("#respAddData").load("addCategoria.php");					         			
				});
...
<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption" >
			<i class="icon-pencil"></i> Categorias
        </div>
	...
	<div class="portlet-body">
		...
		<table align="center" class="table  table-striped table-bordered">
			<tr>
				...
				<td align="center"><b>Nombre Categoría</b></td>
