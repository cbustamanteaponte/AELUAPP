      ...
      <div class="page-content">
		 ...
		 <div class="portlet box blue">
					  <div class="portlet-title">
						 <div class="caption">
							<i class="icon-pencil"></i>Editar Lugar
						 </div>
					  </div>
				 ...
				 <form role="form" name="form_mapa" action="EditLugarProc.php" method="post" enctype="multipart/form-data">			  
				  <div class="form-body">
							   <div class="form-group">
								  <label for="exampleInputEmail1">Nombre:</label>
							   ...
							   <div class="form-group">
								  <label for="exampleInputEmail1">Latitud:</label>
								  <input class="form-control" name="latitud" placeholder="Latitud del lugar" value="<?php echo $latitud;?>" required>
							   </div>
							   <div class="form-group">
								  <label for="exampleInputEmail1">Longitud:</label>
								  <input class="form-control" name="longitud" placeholder="Longitud del lugar"value="<?php echo $longitud;?>"  required>
							   </div>
							   <div class="form-group">
