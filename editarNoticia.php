...
<?php
	{ 
		...
		$idNoticia = $_POST["idNoticia"];//$row['CALC_INV'];
		$titulo = $_POST["titulo"];//$row['CALC_INV'];
...
?>
	...
	<div class="portlet box blue">
		...
		<div class="portlet-body form">
			<form role="form" action="EditNoticiaProc.php" enctype="multipart/form-data" method="post">
				<div class="form-body">
					<div class="form-group">
								  <label for="exampleInputEmail1">Nombre:</label>
								  <input type="hidden" name="idNoticia" value="<?php echo $idNoticia;?>">
								  <input class="form-control" name="titulo" placeholder="Título de la noticia" value="<?php echo $titulo;?>" required>
					 </div>
					 <div class="form-group">
