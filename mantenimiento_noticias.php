		   ...
		   function IsNumeric(input){
            ...
            $(function(){
                ...
                $(".btnModal").click(function(){
                    var idNoticia=$(this).attr("id_obj");
					var titulo=$(this).attr("titulo");
					var imagen=$(this).attr("imagen");					
					var logo=$(this).attr("logo");
					
					$variablesPase = {'idNoticia':idNoticia, 'titulo':titulo,'imagen':imagen,'logo':logo};
					...
					if(relacionado=="seeObj"){
						...
						$("#respEditData").load("editarNoticia.php",$variablesPase);
					}else if(relacionado=="removeObj"){
						var r=window.confirm("¿Desea eliminar el objeto seleccionado?");
						if (r==true){
							$("#respDelete").load("eliminarNoticiaProc.php",{'idNoticia':idNoticia});
							$(".fila").each(function(){
								if($(this).attr("id_obj")==idNoticia){
									$(this).remove();
								}
							})
							var total = 0;
				...
				$("#btnNuevo").click(function(){
					$("#respAddData").load("addNoticia.php");					         			
				});
...
<?php
	...
	/*
		...
		*/
		include "dbconex.php";
		$sql = "select * from Noticia where Activo='ACT';";
		$conn = conectarBD();
...
<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption" >
			<i class="icon-pencil"></i> Noticias
        </div>
